<?php
/*
Plugin Name: Gravity Forms Utilities by onepoint21
Version: 1.3
Author: Rob Hill
Author URI: mailto:robh71@gmail.com
Description: Gravity Forms Utilities by onepoint21
*/
...
function onepoint21_gravityforms_add_merge_tags( $form ) {
    ...
    <script type="text/javascript">
        ...
        function onepoint21_gf_merge_tags(mergeTags, elementId, hideAllFields, excludeFieldTypes, isPrepop, option){
            mergeTags["custom"].tags.push({ tag: '{onepoint21_referred}', label: 'Referred Page' });
...
function onepoint21_useragentapi_get() {
    if ( isset( $_SESSION['useragentapi_result'] ) && isset( $_SESSION['useragentapi_result']->data) ) {
...
function onepoint21_useragentapi( $user_agent ) {
    $useragentapi_key = '2349b20e';
    $ua = urlencode( $user_agent );
    $ch = curl_init();
    curl_setopt( $ch, CURLOPT_URL, "http://useragentapi.com/api/v4/json/$useragentapi_key/$ua" );
...
function onepoint21_useragentapi_ua_type() {
    ...
    if ( isset( $useragentapi_result ) && isset( $useragentapi_result->data ) )
        return $useragentapi_result->data->ua_type;
    elseif ( isset( $useragentapi_result ) && isset( $useragentapi_result->error ) )    
        return $useragentapi_result->error->code . ': ' . $useragentapi_result->error->message;
    else
...
function onepoint21_useragentapi_os_name() {
    ...
    if ( isset( $useragentapi_result ) && isset( $useragentapi_result->data ) )
        return $useragentapi_result->data->os_name;
    elseif ( isset( $useragentapi_result ) && isset( $useragentapi_result->error ) )    
        return $useragentapi_result->error->code . ': ' . $useragentapi_result->error->message;
    else
        return "No data returned";
...
function onepoint21_useragentapi_os_version() {
    ...
    if ( isset( $useragentapi_result ) && isset( $useragentapi_result->data ) )
        return $useragentapi_result->data->os_version;
    elseif ( isset( $useragentapi_result ) && isset( $useragentapi_result->error ) )    
        return $useragentapi_result->error->code . ': ' . $useragentapi_result->error->message;
    else
        return "No data returned";
...
function onepoint21_useragentapi_browser_name() {
    ...
    if ( isset( $useragentapi_result ) && isset( $useragentapi_result->data ) )
        return $useragentapi_result->data->browser_name;
    elseif ( isset( $useragentapi_result ) && isset( $useragentapi_result->error ) )    
        return $useragentapi_result->error->code . ': ' . $useragentapi_result->error->message;
    else
        return "No data returned";
...
function onepoint21_useragentapi_browser_version() {
    ...
    if ( isset( $useragentapi_result ) && isset( $useragentapi_result->data ) )
        return $useragentapi_result->data->browser_version;
    elseif ( isset( $useragentapi_result ) && isset( $useragentapi_result->error ) )    
        return $useragentapi_result->error->code . ': ' . $useragentapi_result->error->message;
    else
        return "No data returned";
...
function onepoint21_useragentapi_engine_name() {
    ...
    if ( isset( $useragentapi_result ) && isset( $useragentapi_result->data ) )
        return $useragentapi_result->data->engine_name;
    elseif ( isset( $useragentapi_result ) && isset( $useragentapi_result->error ) )    
        return $useragentapi_result->error->code . ': ' . $useragentapi_result->error->message;
    else
        return "No data returned";
...
function onepoint21_useragentapi_engine_version() {
    ...
    if ( isset( $useragentapi_result ) && isset( $useragentapi_result->data ) )
        return $useragentapi_result->data->engine_version;
    elseif ( isset( $useragentapi_result ) && isset( $useragentapi_result->error ) )    
        return $useragentapi_result->error->code . ': ' . $useragentapi_result->error->message;
    else
        return "No data returned";
