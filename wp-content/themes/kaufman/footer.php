<footer>
	...
	<div class="inner_footer">
		...
		<div class="footer_left">
			...
			<svg id="footer_gold_twolines" overflow="visible" viewBox="0 0 158.39 21.46">
				
				<polyline class="gold_line_one" points="135.79 20.66 123.59 11.66 112.49 19.86 101.39 11.66 90.29 19.86 79.29 11.66 68.19 19.86 57.09 11.66 45.99 19.86 34.89 11.66 23.89 19.86 12.79 11.66 0.59 20.66"/>
				
				<polyline class="gold_line_two" points="157.79 10.24 145.59 1.25 134.49 9.45 123.39 1.25 112.29 9.45 101.29 1.25 90.19 9.45 79.09 1.25 67.99 9.45 56.89 1.25 45.89 9.45 34.79 1.25 22.59 10.24"/>
...
<div class="copyright">
		...
		<div class="inner_copyright">
			...
			<svg id="footer_threelines" data-name="section three gold twolines" overflow="visible" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 190.06 86"><defs><style>.cls-1{fill:none;}</style></defs>
				...
				<polyline id="black_line_two" points="168.2 29 156 20 144.9 28.2 133.8 20 122.7 28.2 111.7 20 100.6 28.2 89.5 20 78.4 28.2 67.3 20 56.3 28.2 45.2 20 33 29"/>
