...
<div class="sidebar_wrapper">
	...
	<div class="sidebar">
		...
		<div class="sidebar_pa_wrapper">
			...
			<span class="sidebar_blog_large_header">recent posts</span><!-- sidebar_large_header -->
			
			<div class="recent_posts_feed sidebar_feed">
				
					<?php dynamic_sidebar( 'recentpostssidebar' ); ?>
	...
	<div class="sidebar lower_sidebar">
		...
		<div class="sidebar_pa_wrapper">
			...
			<span class="sidebar_blog_large_header">categories</span><!-- sidebar_large_header -->
			
			<div class="recent_posts_feed sidebar_feed">
				
					<?php dynamic_sidebar( 'categoriessidebar' ); ?>
	...
	<div class="sidebar lower_sidebar">
		...
		<div class="sidebar_pa_wrapper">
			...
			<span class="sidebar_blog_large_header">archive</span><!-- sidebar_large_header -->
			
			<div class="recent_posts_feed sidebar_feed">
				
					<?php dynamic_sidebar( 'archivessidebar' ); ?>
